        ...
        <div className='flex flex-col bg-gradient-to-b from-emerald-200 to-white h-auto w-auto'>
            <div className='travigo-container grid items-start justify-items-center'>
                <div className='grid items-center justify-items-center mt-36 mb-16 md:mt-28 md:mb-12'>
                    <h1 className='font-bold text-7xl lg:text-6xl md:text-5xl sm:4xl xsm:text-3xl 
                    text-black filter drop-shadow-lg'>{title}</h1>
                    <h1 className='font-bold text-7xl lg:text-6xl md:text-5xl sm:4xl xsm:text-3xl 
                    text-black filter drop-shadow-lg'>{subtitle}</h1>
                ...
                <div className='flex items-center justify-center mb-11'>
                    <img src={img} alt="dashboard/img"  className='h-[85vh] w-full 
                    object-fill lg:h-[75vh] md:h-[57vh] sm:-[35vh] sm:object-contain drop-shadow-emrald'/>
                </div>
            </div>
        </div>
        </>
